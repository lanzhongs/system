 ...
 *********************************************************/
#define conf_mtsi_dclk  		(CTRL_BASE + 0x8c8)
#define conf_mtsi_data0 		(CTRL_BASE + 0x8cc)
#define conf_mtsi_data1 		(CTRL_BASE + 0x8d0)
#define conf_mtsi_data2 		(CTRL_BASE + 0x8d4)
#define conf_mtsi_data3 		(CTRL_BASE + 0x8d8)
#define conf_mtsi_data4 		(CTRL_BASE + 0x8dc)
#define conf_mtsi_data5 		(CTRL_BASE + 0x8e0)
#define conf_mtsi_data6 		(CTRL_BASE + 0x8e4)
#define conf_mtsi_data7 		(CTRL_BASE + 0x8e8)
#define conf_mtsi_bytstrt 	(CTRL_BASE + 0x8ec)
#define conf_mtso_dclk		(CTRL_BASE + 0x8f0)
#define conf_mtso_data0		(CTRL_BASE + 0x8f4)
#define conf_mtso_data1		(CTRL_BASE + 0x8f8)
#define conf_mtso_data2		(CTRL_BASE + 0x8fc)
#define conf_mtso_data3		(CTRL_BASE + 0x900)
#define conf_mtso_data4		(CTRL_BASE + 0x904)
#define conf_mtso_data5		(CTRL_BASE + 0x908)
#define conf_mtso_data6		(CTRL_BASE + 0x90c)
#define conf_mtso_data7		(CTRL_BASE + 0x910)
#define conf_mtso_bytstrt		(CTRL_BASE + 0x914)
#define conf_mctl_sclk		(CTRL_BASE + 0x918)
#define conf_mctl_sctl		(CTRL_BASE + 0x91c)
#define conf_mctl_sdi			(CTRL_BASE + 0x920)
#define conf_mctl_sdo			(CTRL_BASE + 0x924)
...
int board_eth_init(bd_t *bis)
{
	...
	printf("Reading macaddr from E-fuse..");
	...
	if(!is_valid_ether_addr(mac_addr)) {
		printf("Using default macaddr from u-boot!\n");
		eth_getenv_enetaddr("ethaddr", mac_addr);
	}
	//here,we must success
...
void set_muxconf_regs(void)
{
	...
	/* MUX_DEFAULT(); */
    /* config EMAC1 pinmux */
    __raw_writel(M1,conf_mtsi_dclk);
    __raw_writel(M1,conf_mtsi_data0);
    __raw_writel(M1,conf_mtsi_data1);
    __raw_writel(M1,conf_mtsi_data2);
    __raw_writel(M1,conf_mtsi_data3);
    __raw_writel(M1,conf_mtsi_data4);
    __raw_writel(M1,conf_mtsi_data5);
    __raw_writel(M1,conf_mtsi_data6);
    __raw_writel(M1,conf_mtsi_data7);
    __raw_writel(M1,conf_mtsi_bytstrt);
    __raw_writel(M1,conf_mtso_dclk);
    __raw_writel(M1,conf_mtso_data0);
    __raw_writel(M1,conf_mtso_data1);
    __raw_writel(M1,conf_mtso_data2);
    __raw_writel(M1,conf_mtso_data3);
    __raw_writel(M1,conf_mtso_data4);
    __raw_writel(M1,conf_mtso_data5);
    __raw_writel(M1,conf_mtso_data6);
    __raw_writel(M1,conf_mtso_data7);
    __raw_writel(M1,conf_mtso_bytstrt);
    __raw_writel(M1,conf_mctl_sclk);
    __raw_writel(M1,conf_mctl_sctl);
    __raw_writel(M1,conf_mctl_sdi);
    __raw_writel(M1,conf_mctl_sdo);
}
